...
latitudes = pd.Series.tolist(combined['lat'])
longitudes = pd.Series.tolist(combined['lon'])
...
latitudes = pd.Series.tolist(districts['lat'])
longitudes = pd.Series.tolist(districts['lon'])
