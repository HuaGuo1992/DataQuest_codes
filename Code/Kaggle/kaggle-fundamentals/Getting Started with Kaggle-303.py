...
label_age = ['Missing', 'Infant', 'Child', 'Teenager', 'Young Adult', 'Adult', 'Senior']
cut_points_age = [-1, 0, 5, 12, 18, 35, 60, 100]

train = process_age(train, cut_points_age, label_age)
test = process_age(test, cut_points_age, label_age)

pivoit_table = train.pivot_table(index='Age_categories', values='Survived')
pivoit_table.plot.bar()
plt.show()
