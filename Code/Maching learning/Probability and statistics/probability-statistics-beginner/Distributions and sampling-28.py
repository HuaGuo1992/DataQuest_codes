...
lowest_income = income['median_income'].min()
lowest_income_county = income[income['median_income'] == lowest_income]['county']
...
# Plot a histogram with 6 bins (1 for each possible outcome of the di e roll)
