...
median_difference_sum = (np.array(values - values_median)).sum()
...
fta_blk_cov = cov(nba_stats['fta'], nba_stats['blk'])
ast_stl_cov = cov(nba_stats['ast'], nba_stats['stl'])

r_fta_blk = fta_blk_cov / (nba_stats['fta'].std() * nba_stats['blk'].std())
r_ast_stl = ast_stl_cov / (nba_stats['ast'].std() * nba_stats['stl'].std())