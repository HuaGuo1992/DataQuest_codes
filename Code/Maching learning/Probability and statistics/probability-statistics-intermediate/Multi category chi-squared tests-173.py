...
chiq_valu, pvalue_gender_income = chisquare(observed, expected)
...
tab = pd.crosstab(income['sex'], [income['race']])

chisq_value, pvalue_gender_race, df, expected = chi2_contingency(tab)