...
for theta1 in theta1s:
    cost_list.append(cost(theta0, theta1, pga.distance, pga.accuracy))

import matplotlib.pyplot as plt
plt.plot(theta1s, cost_list)
plt.show()
...
result = gradient_descent(pga.distance, pga.accuracy, alpha = 0.01)

import matplotlib.pyplot as plt
plt.scatter(range(len(result['costs'])), result['costs'])
plt.show()