...
# Enter your answer belore
responds2 = requests.get('http://api.open-notify.org/iss-pass')
status_code = responds2.status_code

## 5. Hitting the Right Endpoint ##

# Enter your answer below.
respond = requests.get('http://api.open-notify.org/iss-pass.json')
