...
# Now, instead of mixing strings and bytes, we can use the replace method with bytes objects instea
...
sentences_cia = pd.DataFrame(sentences_cia[1:][0:], columns = sentences_cia[0][0:])
...
# filtered_token_counts has been loa
